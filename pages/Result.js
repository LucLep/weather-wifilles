...
const Result = ({route}) => {
    ...
    const fetchWeather = (longitude, latitude) => {
        ...
        axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${latitude}&lon=${longitude}&units=metric&exclude=alerts,hourly,minutely&appid=${APIKey}`).then((response) => {
